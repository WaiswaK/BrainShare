...
namespace BrainShare.Core
{
    class NotesTask
    {
        ...
        {
            GetAssignmentsImagesSubjectsAsync(subjects);
            GetTopicsImagesSubjectsAsync(subjects);
        }
        private static void GetTopicsImagesSubjectsAsync(List<SubjectModel> subjects)
        {
        ...
        private static void GetAssignmentsImagesSubjectsAsync(List<SubjectModel> subjects)
        {
