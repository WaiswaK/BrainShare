...
namespace BrainShare.Views
{
    ...
    /// </summary>
    public sealed partial class AssignmentsView : Page
    {
        ...
        private void navigationHelper_LoadState(object sender, LoadStateEventArgs e)
        {
            try
            {
                var categories = e.NavigationParameter as CategoryModel;
                CategoryViewModel vm = new CategoryViewModel(categories);
                DataContext = vm;
            }
            catch
            {
